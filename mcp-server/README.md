...
- **3.25% Fee** (fiat or USDC) — Best value in AI agent commerce (best value — 3.25% includes escrow + insurance + reputation + referral income. OpenAI+ACP charges ~7% for discovery alone)
